  ...
  return (
    <div className="flex flex-col gap-5 animate-fade-in stagger-children">
      ...
      <div className="animate-fade-in-scale flex flex-wrap justify-between items-end gap-2">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold font-display text-slate-900 dark:text-white">Dashboard</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Real-time insole biomechanics overview</p>
        </div>
        <div className="flex items-center gap-2">
          <span className="live-dot" />
          <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400">Live Telemetry 50 Hz</span>
        </div>
      </div>
          ...
          <div className="flex-1 min-w-0 w-full text-center sm:text-left">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mb-2">
              <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold ${actColor.bg} ${actColor.border} ${actColor.text} border`}>
                <span className={`w-2 h-2 rounded-full ${actColor.dot}`} />
                {activity}
              </span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3 pt-3 border-t border-slate-200/70 dark:border-white/[0.05]">
              <div className="bg-slate-100/70 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/50 dark:border-white/[0.03]">
                <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold block">Cadence</span>
                <span className="text-base font-mono font-bold text-slate-900 dark:text-white">
                  {cadence} <span className="text-[10px] text-slate-500 font-normal">SPM</span>
                </span>
              </div>
              <div className="bg-slate-100/70 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/50 dark:border-white/[0.03]">
                <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold block">Symmetry</span>
                <span className="text-base font-mono font-bold text-amber-600 dark:text-amber-300">
                  {symmetry.toFixed(1)}<span className="text-[10px] text-slate-500 font-normal">%</span>
                </span>
              </div>
              <div className="bg-slate-100/70 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/50 dark:border-white/[0.03]">
                <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold block">Goal</span>
                <span className="text-base font-mono font-bold text-cyan-600 dark:text-cyan-400">
                  {stepPct}%
                </span>
              </div>
              <div className="bg-slate-100/70 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/50 dark:border-white/[0.03]">
                <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase font-semibold block">Impact</span>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 stagger-children">
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="p-2.5 rounded-xl bg-cyan-500/10 border border-cyan-500/20 group-hover:shadow-glow-cyan transition-all">
                  <Footprints className="w-5 h-5 text-cyan-600 dark:text-cyan-400" />
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-cyan-500 transition-colors" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Pressure Map</h3>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Plantar FSR heatmap</p>
            </div>
            <div className="flex items-center gap-1.5 mt-3 pt-2 border-t border-slate-200/50 dark:border-white/[0.04]">
              <span className="text-[10px] font-mono text-cyan-600 dark:text-cyan-400 font-bold">H: {sensors.p1}</span>
              <span className="text-slate-400">•</span>
              <span className="text-[10px] font-mono text-cyan-600 dark:text-cyan-400 font-bold">F: {sensors.p2}</span>
            </div>
          </button>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 group-hover:shadow-glow-emerald transition-all">
                  <Activity className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-emerald-500 transition-colors" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Gait Analytics</h3>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Stride telemetry & trends</p>
            </div>
            <div className="flex items-center gap-1.5 mt-3 pt-2 border-t border-slate-200/50 dark:border-white/[0.04]">
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="p-2.5 rounded-xl bg-violet-500/10 border border-violet-500/20 transition-all">
                  <Brain className="w-5 h-5 text-violet-600 dark:text-violet-400" />
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-violet-500 transition-colors" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">IMU Motion</h3>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">6-DOF spatial kinematics</p>
            </div>
            <div className="flex items-center gap-1.5 mt-3 pt-2 border-t border-slate-200/50 dark:border-white/[0.04]">
              <span className="text-[10px] font-mono text-violet-600 dark:text-violet-400 font-bold">SVM: {imu.svmA}g</span>
              <span className="text-slate-400">•</span>
              <span className="text-[10px] font-mono text-slate-500">{imu.pitch}°</span>
            </div>
          </button>
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="p-2.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 transition-all">
                  <ShieldCheck className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-emerald-500 transition-colors" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Fall Guard</h3>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">Dual-trigger safety shield</p>
            </div>
            <div className="flex items-center gap-1.5 mt-3 pt-2 border-t border-slate-200/50 dark:border-white/[0.04]">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-white/[0.06]">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs font-mono font-bold text-slate-900 dark:text-white">{batteryPct}%</span>
          </div>
